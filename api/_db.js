...
// Use /tmp for Vercel serverless (ephemeral but works within single invocation)
const DB_PATH = process.env.VERCEL ? '/tmp/queue.json' : path.join(__dirname, '..', 'queue.json');
